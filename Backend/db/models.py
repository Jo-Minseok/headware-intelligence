...
from sqlalchemy import CheckConstraint, Column, BigInteger, VARCHAR, Time, Float, ForeignKey, Date, DECIMAL
...
class Accident(Base):
    ...
    latitude = Column(DECIMAL(15, 12), nullable=False, default=1.0)
    longitude = Column(DECIMAL(15, 12), nullable=False, default=1.0)
    __table_args__ = (
        CheckConstraint(
